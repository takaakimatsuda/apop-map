<x-app-layout>
    ...
    <div class="container mx-auto p-4" style="width: 50%;">
        <form action="{{ route('events.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <!-- 画像アップロード -->
            <div class="mb-6">
                <label for="image_url" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">イベント画像:</label>
            ...
            <div class="grid grid-cols-1 gap-6">
                <div class="col-span-1">
                    <label for="title" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">イベント名:</label>
                ...
                <div class="col-span-1">
                    <label for="date" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">開催日:</label>
                    <input type="date" id="date" name="date" required class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                </div>

                <!-- 開始時間と終了時間 -->
                <div class="col-span-1 grid grid-cols-2 gap-6">
                    <div>
                        <label for="start_time" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">開始時間:</label>
                    ...
                    <div>
                        <label for="end_time" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">終了時間:</label>
                ...
                <div class="col-span-1">
                    <label for="venue_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">会場名:</label>
                ...
                <div class="col-span-1">
                    <label for="venue_address" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">会場住所:</label>
                ...
                <div class="col-span-1">
                    <label for="dance_genre" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">ダンスジャンル:</label>
                    <input type="text" id="dance_genre" name="dance_genre" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                </div>

                <div class="col-span-1">
                    <label for="region" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">地域:</label>
                    <input type="text" id="region" name="region" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                </div>

                <div class="col-span-1">
                    <label for="description" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">説明:</label>
                ...
                <div class="col-span-1">
                    <label for="reference_url" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">参考URL:</label>
